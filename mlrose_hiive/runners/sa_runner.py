...
class SARunner(_RunnerBase):
    ...
    def __init__(self, problem, experiment_name,
                 seed, iteration_list,
                 temperature_list,
                 temperature_decay_list,
                 decay_list=None,
        ...
        self.temperature_decay_list = temperature_decay_list
        if decay_list is None:
            decay_list = [mlrose_hiive.GeomDecay]
        self.decay_list = decay_list

    def run(self):
        temperatures = [decay(init_temp=t, decay=d)
